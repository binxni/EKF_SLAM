...
foreach(_expectedTarget ekf_slam::ekf_slam_lib)
...
# Create imported target ekf_slam::ekf_slam_lib
add_library(ekf_slam::ekf_slam_lib STATIC IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_ekf_slamExport-*.cmake")
